...
$router->group(['prefix' => 'api/v1', 'as' => 'api.v1'], function () use ($router, $customRouter) {
    ...
    $router->group(['prefix' => 'public', 'as' => 'public'], function () use ($router) {
        ...
        $router->get("industry-association-member-details", ["as" => "public.industry-association-member-details", "uses" => "IndustryAssociationController@getPublicIndustryAssociationMemberDetails"]);
    });
