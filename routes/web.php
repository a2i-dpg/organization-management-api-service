...
$router->group(['prefix' => 'api/v1', 'as' => 'api.v1'], function () use ($router, $customRouter) {
    ...
    $router->group(['middleware' => 'auth'], function () use ($customRouter, $router) {
        ...
        $router->group(["prefix" => "jobs", "as" => "jobs"], function () use ($router) {
            ...
            $router->delete('recruitment-step-candidate-list/{jobId}/{stepId}', ["as" => "recruitment-step.candidate-list", "uses" => "JobManagementController@recruitmentStepcandidateList"]);
