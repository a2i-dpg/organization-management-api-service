...
public class ApiClient {
    ...
    private String basePath = "http://localhost:8002/api/v1";
    ...
    public ApiClient() {
        ...
        authentications.put("User-Token", new ApiKeyAuth("header", "User-Token"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://localhost:8002/api/v1
