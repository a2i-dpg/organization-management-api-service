...
class FourIROccupationPolicy
{
    ...
    {
        return $authUser->hasPermission('view_any_4ir_occupations');
    ...
    {
        return $authUser->hasPermission('view_single_4ir_occupations');
    ...
    {
        return $authUser->hasPermission('create_4ir_occupations');
    }
     ...
     *
     * @param User $authUser
    $fourIROccupation     * @return bool
     */
    public function update(User $authUser, FourIROccupation $fourIROccupation): bool
    {
        return $authUser->hasPermission('update_4ir_occupations');
    }
    ...
    {
        return $authUser->hasPermission('delete_4ir_occupations');
    }
}
