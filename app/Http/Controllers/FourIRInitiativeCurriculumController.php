...
use App\Services\FourIRServices\FourIRInitiativeCurriculumService;
use Carbon\Carbon;
...
class FourIRInitiativeCurriculumController extends Controller
{
    public FourIRInitiativeCurriculumService $fourIrInitiativeCsCurriculumCblmService;
     ...
     *
     * @param FourIRInitiativeCurriculumService $fourIrInitiativeCsCurriculumCblmService
     * @param FourIRFileLogService $fourIRFileLogService
     */
    public function __construct(FourIRInitiativeCurriculumService $fourIrInitiativeCsCurriculumCblmService, FourIRFileLogService $fourIRFileLogService)
    {
...
//        $this->authorize('view', $fourIrProject);
        ...
        try {
            ...
            $response = [
                ...
                '_response_status' => [
                    ...
                    "message" => "Four Ir Initiative Curriculum added successfully",
                    "query_time" => $this->startTime->diffInSeconds(Carbon::now())
                ]
            ];
        } catch (Throwable $e){
    ...
    public function update(Request $request, int $id): JsonResponse
    {
        ...
        try {
            ...
            $this->fourIRFileLogService->updateFileLog($filePath, $data->toArray(), FourIRInitiative::FILE_LOG_PROJECT_CURRICULUM_STEP);
            ...
            $response = [
                ...
                '_response_status' => [
                    "success" => true,
                    "code" => ResponseAlias::HTTP_OK,
                    "message" => "Four Ir Initiative Curriculum updated successfully",
                    "query_time" => $this->startTime->diffInSeconds(Carbon::now())
                ]
            ];
        } catch (Throwable $e){
