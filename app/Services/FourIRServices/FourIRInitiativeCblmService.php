 ...
 */
class FourIRInitiativeCblmService
{
    /**
     * @param array $request
    ...
    public function getFourIRInitiativeCsCurriculumCblmList(array $request, Carbon $startTime): array
    {
        ...
        $fourIrInitiativeCsCurriculumCblmBuilder = FourIRInitiativeCsCurriculumCblm::select([
            ...
            'four_ir_initiative_cs_curriculum_cblm.sector_id',
        ...
        $fourIrInitiativeCsCurriculumCblmBuilder->where('four_ir_initiative_cs_curriculum_cblm.type', FourIRInitiativeCsCurriculumCblm::TYPE_CBLM);
    ...
    public function store(array $data): FourIRInitiativeCsCurriculumCblm
    {
        ...
        $data['type'] = FourIRInitiativeCsCurriculumCblm::TYPE_CBLM;
