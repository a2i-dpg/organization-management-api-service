...
class FourIRInitiative extends BaseModel
{
    ...
    public const  TASK_ROADMAP_FINALIZED_KEY = "TASK_ROADMAP_FINALIZED";
    public const  TASK_PROJECT_REVIEWED_BY_SECRETARY_OF_RELEVANT_MINISTRIES_KEY = "TASK_PROJECT_REVIEWED_BY_SECRETARY_OF_RELEVANT_MINISTRIES";
    public const  TASK_PROJECT_APPROVED_KEY = "TASK_PROJECT_APPROVED";
    public const TASKS = [
        self::TASK_ROADMAP_FINALIZED_KEY => self::TASK_ROADMAP_FINALIZED,
        self::TASK_PROJECT_REVIEWED_BY_SECRETARY_OF_RELEVANT_MINISTRIES_KEY => self::TASK_PROJECT_REVIEWED_BY_SECRETARY_OF_RELEVANT_MINISTRIES,
        self::TASK_PROJECT_APPROVED_KEY => self::TASK_PROJECT_APPROVED,
    ];
