...
class CreateSmefMembersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('smef_members', function (Blueprint $table) {
            ...
            /** Common attributes between industry and smef */
             ...
             * ->index('smef_member_loc_division_id_inx');
             * $table->unsignedMediumInteger('loc_district_id')->nullable()
             * ->index('smef_member_loc_district_id_inx');
             * $table->unsignedMediumInteger('loc_upazila_id')->nullable()
             * ->index('smef_member_loc_upazila_id_inx');
            ...
            $table->unsignedMediumInteger('factory_loc_district_id')->nullable()
                ->index('smef_member_fk_factory_loc_district_id');
            $table->unsignedMediumInteger('factory_loc_upazila_id')->nullable()
                ->index('smef_member_fk_factory_loc_upazila_id');
            ...
            $table->unsignedMediumInteger('chamber_or_association_loc_district_id')->nullable()->index('smef_member_fk_chamber_or_association_loc_district_id');
    ...
    {
        Schema::dropIfExists('smef_members');
    }
}
