...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'rabbitmq' => [
            'driver' => 'rabbitmq',
            'queue' => env('RABBITMQ_QUEUE','organization.q'),
            ...
            'options' => [
                'queue' => [
                    'exchange' => env('RABBITMQ_EXCHANGE_NAME','organization.x'),
                    'exchange_type' => env('RABBITMQ_EXCHANGE_TYPE','topic'),
                    'exchange_routing_key' => env('EXCHANGE_ROUTING_KEY','organization.routing.key'),
                ...
                'exchange' => [
                    'name' => env('RABBITMQ_EXCHANGE_NAME','organization.x'),
                ...
                'alternate_exchange' => [
                    'name' => env('RABBITMQ_ALTERNATE_EXCHANGE', 'organization.alternate.x'),
                    'type' => env('RABBITMQ_ALTERNATE_EXCHANGE_TYPE','fanout'),
                    'queue' => env('RABBITMQ_ALTERNATE_QUEUE','organization.alternate.q')
                ],
                'dlx' => [
                    'name' => env('RABBITMQ_RETRY_DLX', 'organization.dlx'),
                    'type' => env('RABBITMQ_RETRY_DLX_TYPE', 'fanout'),
                    'dlq' => env('RABBITMQ_RETRY_DLQ', 'organization.dlq'),
